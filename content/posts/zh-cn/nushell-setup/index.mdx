...
Nushell 的默认配置文件可以从 [GitHub 仓库](https://github.com/nushell/nushell/blob/fb2610904997f54f50ad52095948bede81695f31/crates/nu-utils/src/default_files/doc_config.nu) 中找到，其更新的比 [官方文档](https://www.nushell.sh/book/configuration.html) 及时。
